...
public class InstantCodecTest {
    ...
    public Object[][] formatParameters() {
        return new Object[][]{
            { Instant.parse("2010-06-30T01:20:47.999Z"), quote(Instant.parse("2010-06-30T01:20:47.999Z").toString()) },
            { Instant.parse("2010-06-30T01:20:47.999+05:00"), quote(Instant.parse("2010-06-30T01:20:47.999+05:00").toString()) }
        };
    }
